...
variable "main_api_server_domain" {
  ...
  type        = string
  default     = "armankhan.me" # Your backend domain you created a route53 zone for
}

variable "dev_api_server_domain" {
  description = "Dev API Server Domain"
  type        = string
  default     = "chattyapi.dev.armankhan.me"
}
...
variable "prefix" {
  ...
  type        = string
  default     = "chattyapp-server" # Add a unique identifier name
}
